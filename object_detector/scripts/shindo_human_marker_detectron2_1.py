...
def PcdCallback(point_cloud): 
    ...
    if len(rect_list)>1:
        print(pc.shape)
        print([rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"],])
        print(pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]])
        
        if not pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]][0] == 0 and not pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]][2]
            # print("marker1.pose.position.x1", marker1.pose.position.x)
        elif not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]][0] == 0 and not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]][1]== 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]][2]
            # print("marker1.pose.position.x2", marker1.pose.position.x)
        elif not pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]+1][0] == 0 and not pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]+1][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]+1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]+1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"], rect_list[1]["bd_center_px"]+1][2]
        ...
        elif not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]+1][0] == 0 and not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]+1][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]+1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]+1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]+1][2]
            # print("marker1.pose.position.x6", marker1.pose.position.x)
        elif not pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]+1][0] == 0 and not pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]+1][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]+1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]+1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]+1][2]
        elif not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_px"]-1][0] == 0 and not pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_x"]-1][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_x"]-1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_x"]-1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"]+1, rect_list[1]["bd_center_x"]-1][2]
        elif not pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]-1][0] == 0 and not pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]-1][1] == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]-1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]-1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_py"]-1, rect_list[1]["bd_center_px"]-1][2]
        ...
        print("marker1.pose.position", marker1.pose.position, marker1.pose.position.y)
