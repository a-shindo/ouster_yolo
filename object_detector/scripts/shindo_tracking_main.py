...
for videoPath in videos:
    ...
    if video_basename[-4:]==".mp4":
        detector.onVideo(videoPath=videoPath,savePath=f"/home/ytpc2017d/catkin_ws/src/object_detector/scripts/temp/results2/{video_basename}", csvPath=f'/home/ytpc2017d/catkin_ws/src/object_detector/csv2/{video_basename[:-4]}.csv')
