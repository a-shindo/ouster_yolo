...
def PcdCallback(point_cloud): 
    ...
    if len(rect_list)>2:
        print(pc.shape)
        # print([rect_list[2]["bd_center_y"], rect_list[2]["bd_center_x"]])
        # print(pc[rect_list[2]["bd_center_y"], rect_list[2]["bd_center_x"]])
        
        if not pc[rect_list[3]["bd_center_y"], rect_list[3]["bd_center_x"]][0] == 0 and not pc[rect_list[3]["bd_center_y"], rect_list[3]["bd_center_x"]][1] == 0:
            marker1.pose.position.x = pc[rect_list[3]["bd_center_y"], rect_list[3]["bd_center_x"]][0]
            marker1.pose.position.y = pc[rect_list[3]["bd_center_y"], rect_list[3]["bd_center_x"]][1]
            marker1.pose.position.z = pc[rect_list[3]["bd_center_y"], rect_list[3]["bd_center_x"]][2]
            print("marker1.pose.position.x1", marker1.pose.position.x)
        elif not pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]][0] == 0 and not pc[rect_list[1]["bd_center_y"]+1, rect_list[2]["bd_center_x"]][1]== 0:
        ...
        elif not pc[rect_list[1]["bd_center_y"], rect_list[1]["bd_center_x"]+1][0] == 0 and not pc[rect_list[1]["bd_center_y"], rect_list[1]["bd_center_x"]+1][1] == 0:
        ...
        elif not pc[rect_list[1]["bd_center_y"], rect_list[1]["bd_center_x"]-1][0] == 0 and not pc[rect_list[1]["bd_center_y"], rect_list[1]["bd_center_x"]-1][1]-1 == 0:
            marker1.pose.position.x = pc[rect_list[2]["bd_center_y"], rect_list[2]["bd_center_x"]-1][0]
            marker1.pose.position.y = pc[rect_list[2]["bd_center_y"], rect_list[2]["bd_center_x"]-1][1]
            marker1.pose.position.z = pc[rect_list[2]["bd_center_y"], rect_list[2]["bd_center_x"]-1][2]
            # print("marker1.pose.position.x5", marker1.pose.position.x)
        elif not pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]+1][0] == 0 and not pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]+1][1] == 0:
        ...
        elif not pc[rect_list[1]["bd_center_y"]-1, rect_list[1]["bd_center_x"]+1][0] == 0 and not pc[rect_list[1]["bd_center_y"]-1, rect_list[1]["bd_center_x"]+1][1]+1 == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_y"]-1, rect_list[1]["bd_center_x"]+1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_y"]-1, rect_list[1]["bd_center_x"]+1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_y"]-1, rect_list[1]["bd_center_x"]+1][2]
        elif not pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]-1][0] == 0 and not pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]-1][1]-1 == 0:
            marker1.pose.position.x = pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]-1][0]
            marker1.pose.position.y = pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]-1][1]
            marker1.pose.position.z = pc[rect_list[1]["bd_center_y"]+1, rect_list[1]["bd_center_x"]-1][2]
